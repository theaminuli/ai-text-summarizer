# AI Summary - AI-Powered TL;DR & Content Summary Buttons

[![WordPress Plugin Version](https://img.shields.io/badge/version-0.4.0-blue.svg)](https://github.com/theaminuli/ai-summary/releases)
...
![AI Summary Demo](https://via.placeholder.com/800x400.png?text=AI+Summary+Demo)

---

## 🎯 What is AI Summary?

AI Summary provides customizable button blocks designed specifically for content summarization. Whether you're running a news site, blog, documentation portal, or educational platform, this plugin helps readers quickly identify relevant content and navigate long articles efficiently.
...
2. Search for "AI Summary"
3. Click **Install Now** and then **Activate**
4. The block will appear in the Design category in the block editor

### Manual Installation

1. Download the plugin from the [releases page](https://github.com/theaminuli/ai-summary/releases)
2. Upload the `ai-summary` folder to `/wp-content/plugins/`
...
git clone https://github.com/theaminuli/ai-summary.git
...
│   └── blocks/
│       └── summarize-button/
├── ai-summary.php              # Main plugin file
...
1. **Report Bugs** - Found a bug? [Open an issue](https://github.com/theaminuli/ai-summary/issues)
2. **Suggest Features** - Have an idea? [Submit a feature request](https://github.com/theaminuli/ai-summary/issues)
...
- **Documentation**: [Full documentation](https://github.com/theaminuli/ai-summary/wiki)
- **WordPress.org Support**: [Plugin support forum](https://wordpress.org/support/plugin/ai-summary/)
- **GitHub Issues**: [Report bugs or request features](https://github.com/theaminuli/ai-summary/issues)
- **Email**: support@theaminul.com

### Stay Updated

- **GitHub**: [Star the repo](https://github.com/theaminuli/ai-summary) for updates
- **WordPress.org**: [Follow on WordPress.org](https://wordpress.org/plugins/ai-summary/)
...
![GitHub stars](https://img.shields.io/github/stars/theaminuli/ai-summary?style=social)
![WordPress Plugin Downloads](https://img.shields.io/wordpress/plugin/dt/ai-summary?style=flat-square)
![WordPress Plugin Active Installations](https://img.shields.io/wordpress/plugin/installs/ai-summary?style=flat-square)
![WordPress Plugin Rating](https://img.shields.io/wordpress/plugin/rating/ai-summary?style=flat-square)
...
**[⬆ Back to Top](#ai-summary---ai-powered-tldr--content-summary-buttons)**

Made with ❤️ for the WordPress Community

[Website](https://theaminul.com) • [GitHub](https://github.com/theaminuli) • [WordPress.org](https://wordpress.org/plugins/ai-summary/)
